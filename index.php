...
<div class="container-fulid ">
        ...
        <div class="row text-center ">
            ...
            <div class="col-lg-8 bg bg-primary text-white ">
                <div><h3>HARDY COLLEGE OF TECHNOLOGY - DEPARTMENT OF ICT</h3></div>    
...
<div class="row text-center">
                <div class="col-xl bg-black text-white pa10">
                    ...
                    <p>Designed By: Hardy College Of Technology Student | Founder :<a href="http://am-asky97.herokuapp.com/" class="a"> A.M. Asky</a></p>
                </div>
            </div>
        <!-- End Footer -->
